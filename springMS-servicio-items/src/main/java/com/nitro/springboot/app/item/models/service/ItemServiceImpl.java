package com.nitro.springboot.app.item.models.service;
...
import com.nitro.springboot.app.item.models.Item;
import com.nitro.springboot.app.item.models.Producto;
...
public class ItemServiceImpl implements ItemService {
	...
	public List<Item> findAll() {
		...
		// Converts the list into a stream object to iterate every item and creates a
		// new Item of each Product
